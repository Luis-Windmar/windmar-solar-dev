(() => {
  ...
  var S = {
    header: { backgroundColor: "#ffffff", borderBottom: "3px solid #1B3F8B", padding: "12px 20px", display: "flex", alignItems: "center", justifyContent: "center" },
    logo: { height: "144px", objectFit: "contain" },
    progressWrap: { backgroundColor: "#ffffff", padding: "10px 20px" },
    progressLabel: { fontSize: "12px", color: "#6b7280", marginBottom: "6px", textAlign: "center" },
    progressBar: { height: "6px", backgroundColor: "#e5e7eb", borderRadius: "3px", overflow: "hidden" },
    progressFill: { height: "100%", backgroundColor: "#F5A623", borderRadius: "3px", transition: "width 0.4s ease" }
  };
  var Header = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.header, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: "/logo.png", alt: "Windmar Commercial", style: S.logo }) });
  var ProgressBar = ({ current, total, pct: overridePct }) => {
    const pct = overridePct !== void 0 ? overridePct : Math.round(current / total * 100);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.progressWrap, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.progressLabel, children: [
        "Paso ",
        current,
        " de ",
        total
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.progressBar, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { ...S.progressFill, width: `${pct}%` } }) })
    ] });
  };
  ...
  function getStepLabel(pct) {
    ...
    return "\xA1An\xE1lisis completado!";
  }
  var fmtNum = (val, minDec, maxDec) => {
  ...
  var FIELDS = [
    ...
    { key: "direccion", label: "Direcci\xF3n", type: "textarea", suffix: "" },
  ...
  function normalizeOCR(data) {
    ...
    const nonZero = consumos.map((c, i) => ({ c, t: tasas[i] ?? 0 })).filter((p) => p.c > 0);
    const consumoPromedio = nonZero.length > 0 ? nonZero.reduce((s, p) => s + p.c, 0) / nonZero.length : data.consumo_promedio ?? 0;
    const avgMonthlyBill = nonZero.length > 0 && nonZero.some((p) => p.t > 0) ? nonZero.reduce((s, p) => s + p.c * p.t, 0) / consumos.length : data.total_adeudado ?? 0;
    ...
    return {
      nombreNegocio: data.nombre_negocio ? "TEST - " + data.nombre_negocio : "TEST - ",
      // TODO: remove before production
      direccion: data.address ? "TEST - " + data.address : "TEST - ",
      // TODO: remove before production
  ...
  var MOCK_OCR = {
    nombreNegocio: "TEST - MOC OCR BIZ NAME",
    // TODO: remove before production
    direccion: "TEST - PONCE BY PASS PONCE, PONCE PR 00730",
    // TODO: remove before production
    municipio: "Ponce",
  ...
  function UploadScreen({ onNext, onBack, resumeData }) {
    ...
    const runProcessing = (selectedFiles) => {
      ...
      fetch("/api/ocr", { method: "POST", body: fd }).then((r) => r.json()).then(({ data }) => {
        ocrDone = true;
        ocrResult = data || {};
      }).catch(() => {
        ocrDone = true;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.page, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.content, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "div",
            {
              style: { ...S2.dropZone, ...isDragging ? S2.dropZoneDragging : {} },
              ...
              onDrop: handleDrop,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: "100px", height: "100px", overflow: "hidden", margin: "0 auto 16px" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: "/paperclip_icon.png", alt: "", style: { width: "100px", height: "100px", objectFit: "contain", transform: "scale(1.6)", transformOrigin: "center" } }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S2.dropText, children: "Selecciona un archivo" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S2.dropSub, children: "Foto(s) o PDF \xB7 puedes seleccionar varias p\xE1ginas" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.tipsCard, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: "112px", height: "112px", overflow: "hidden", flexShrink: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: "/lightbulb.png", alt: "", style: { width: "112px", height: "112px", objectFit: "contain", transform: "scale(1.5)", transformOrigin: "center" } }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: S2.tipsTitle, children: "Para mejores resultados..." }),
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.page, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.content, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.fileChip, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: "77px", height: "77px", overflow: "hidden", flexShrink: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: "/utility_bill_cropped.jpg", alt: "", style: { width: "77px", height: "77px", objectFit: "contain", transform: "scale(2.25)", transformOrigin: "center 48%" } }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: fileList.length === 1 ? fileList[0].name : `${fileList.length} archivos seleccionados` }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: "/listo_icon.jpg", alt: "", style: { width: "132px", height: "132px", objectFit: "contain" } })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.processingCard, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S2.processingTrack, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: {
              height: "100%",
              backgroundColor: "#F5A623",
              borderRadius: "5px",
              width: `${progress}%`,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S2.stepLabel, children: stepLabel }),
            CHECKLIST.map(({ text, threshold }, i) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                "div",
                {
                  ...
                  children: [
                    done ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: "/listo_icon.jpg", alt: "", style: { width: "72px", height: "72px", objectFit: "contain", flexShrink: 0 } }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: "/hourglass.png", alt: "", style: { width: "44px", height: "44px", objectFit: "contain", flexShrink: 0 } }),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.page, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.content, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S2.reviewCard, children: FIELDS.map(({ key, label, type, suffix }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.fieldGroup, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: S2.fieldLabel, children: label }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S2.fieldExtracted, children: [
            "Le\xEDdo: ",
            extractedRaw[key] ? extractedRaw[key] + suffix : "\u2014"
          ] }),
          type === "textarea" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "textarea",
            {
              style: S2.fieldTextarea,
              value: fields[key],
  ...
  function RoofScreen({ onNext, onBack }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: S3.page, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: S3.content, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            style: { ...S3.btnNavy, ...canContinue ? {} : S3.btnNavyDisabled },
            disabled: !canContinue,
            onClick: () => onNext(effectiveSqft),
            children: "Continuar"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { style: S3.btnGhost, onClick: onBack, children: "Atr\xE1s" })
      ] })
    ] });
  }
  ...
  function EstimateScreenInner({ ocrData, sqft, batteryHours, setBatteryHours, pricing, onInterested, onNotInterested, onBack }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.page, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressBar, { current: 5, total: 6 }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.content, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h1", { style: S4.h1, children: "Tu estimado" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.row, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S4.rowLabel, children: "Generaci\xF3n:" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.rowLast, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S4.rowLabel, children: "Respaldo estimado:" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S4.rowValue, children: batteryResult ? `${batteryResult.actualHours} horas` : "0 horas" })
          ] })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.row, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S4.rowValue, children: fmtUSD(totalCost) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.rowLast, children: [
        ...
        totalCost >= 6e4 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: S4.sliderValue, children: "\xBFPrefieres financiar?" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.card, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.row, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.row, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S4.rowValue, children: fmtUSD(totalMonthlyPmt) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.rowBold, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S4.rowBoldValue, children: fmtUSD(totalSavingsNet) })
            ] })
          ] })
        ] }) : null,
        ...
        ` }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: S4.sliderValue, children: "Ajusta el nivel de respaldo" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { fontSize: "14px", color: "#374151", textAlign: "center", marginBottom: "10px", marginTop: "-6px" }, children: "Decide cu\xE1nto quieres ahorrarte en tu factura de LUMA" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S4.sliderCard, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: S4.sliderValue, children: localBatteryHours === 0 ? "Sin almacenamiento" : `${localBatteryHours} horas de respaldo` }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: S4.btnOrange, onClick: () => onInterested(est, batteryResult), children: "S\xED me interesa" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: S4.btnGray, onClick: onNotInterested, children: "No por ahora" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: { ...S4.btnGray, backgroundColor: "transparent", color: "#1B3F8B", border: "2px solid #1B3F8B", marginTop: "12px" }, onClick: onBack, children: "Atr\xE1s" })
      ] })
    ] });
  }
  function EstimateScreen(props) {
    try {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(EstimateScreenInner, { ...props });
    } catch (err) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { padding: "24px", backgroundColor: "#fff3cd", minHeight: "100vh" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { style: { color: "#dc2626", marginTop: 0 }, children: "Error en Estimado" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { style: { fontSize: "13px", whiteSpace: "pre-wrap", color: "#7f1d1d" }, children: String(err) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { style: { fontSize: "11px", whiteSpace: "pre-wrap", color: "#6b7280" }, children: err?.stack })
      ] });
    }
  }
  ...
  function ContactScreen({ ocrData, sqft, onNext, onBack }) {
    const [nombre, setNombre] = (0, import_react3.useState)("TEST - ");
    const [phone, setPhone] = (0, import_react3.useState)("");
    const [consultorNombre, setConsultor] = (0, import_react3.useState)("TEST - ");
  ...
  var parseNum2 = (s) => parseFloat(String(s ?? "").replace(/,/g, "").replace(/[^0-9.-]/g, "")) || 0;
  var parseAddress = (fullAddress, municipio) => {
  ...
  function ThankYouScreen({ interested, generateLead = true, contactData, ocrData, sqft, estData, batteryHours, batteryResult, billFiles, onRestart }) {
    ...
    const handleDownload = () => {
      ...
      if (!blob) {
        setPdfError("El estimado a\xFAn no est\xE1 listo.");
        return;
      }
  ...
  function WelcomeScreen() {
    ...
    const [serviceType, setServiceType] = (0, import_react5.useState)("no_se");
    ...
    const [batteryHours, setBatteryHours] = (0, import_react5.useState)(0);
    const [batteryResult, setBatteryResult] = (0, import_react5.useState)(null);
    const [billFiles, setBillFiles] = (0, import_react5.useState)(null);
    const [pricing, setPricing] = (0, import_react5.useState)(null);
    const [pricingLoading, setPricingLoading] = (0, import_react5.useState)(true);
    const [generateLead, setGenerateLead] = (0, import_react5.useState)(true);
    ...
    if (pricingLoading) {
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: styles.container, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", flex: 1, minHeight: "200px" }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { style: { color: "#6b7280", fontSize: "16px" }, children: "Cargando\u2026" }) })
      ] });
    }
    if (screen === "exit") {
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: styles.container, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: styles.content, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: styles.exitCard, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("img", { src: "/hand_shake.jpg", alt: "", style: { width: "384px", height: "384px", objectFit: "contain", display: "block", margin: "0 auto 16px" } }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { style: styles.exitHeading, children: "\xA1Gracias por tu tiempo!" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { style: styles.exitText, children: "Entendemos que este no es el momento ideal. Cuando est\xE9s listo para explorar opciones de energ\xEDa solar, estaremos aqu\xED para ayudarte." }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { style: styles.btnGhost, onClick: handleRestart, children: "Atr\xE1s" })
        ] }) })
      ] });
    }
    if (screen === "upload") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: styles.container, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Header2, {}),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ProgressBar2, { current: 1, total: 6 }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: styles.content, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: "\u2014 Selecciona una opci\xF3n \u2014" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { style: styles.label, children: "\xBFSabes qu\xE9 tipo de servicio el\xE9ctrico tienes?" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "", children: "\u2014 Selecciona una opci\xF3n \u2014" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "bifasico_240", children: "Bif\xE1sico (240V L-L)" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "trifasico_208", children: "Trif\xE1sico (208V)" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "trifasico_480", children: "Trif\xE1sico (480V)" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "no_se", children: "No lo s\xE9" })
            ]
          }
        ),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { marginTop: "32px", textAlign: "center" }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "button",
          {
